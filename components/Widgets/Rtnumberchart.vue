<template>
    ...
    <card type="chart">
        ...
        <template slot="header">
            ...
            <h5 class="card-category">{{ config.selectDevice.name }} - {{ config.varFullName }}</h5>
...
<script>
    export default {
            ...
            config: {
                ...
                handler() {
                    ...
                    setTimeout(() => {
                        ...
                        this.chartOptions.series[0].name = this.config.varFullName + " " + this.config.unit;
        ...
        mounted() {
            ...
            this.$nuxt.$on(this.config.userId + '/' + this.config.selectDevice.dId + '/' + this.config.variable + "/sdata", this.procesReceivedData);
        ...
        beforeDestroy() {
            this.$nuxt.$off(this.config.userId + '/' + this.config.selectDevice.dId + '/' + this.config.variable + "/sdata", this.procesReceivedData);
        },
        methods: {
            ...
            getChartData() {
                ...
                const axiosHeaders = {
                    ...
                    params: { dId: this.config.selectDevice.dId, variable: this.config.variable, chartTimeAgo: this.config.chartTimeAgo }
                }

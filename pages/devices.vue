          ...
          <el-table-column label="Actions">
            ...
            <div slot-scope="{row, $index}">
                ...
                <el-tooltip content="Database Saver">
                    <base-switch color="black" :value= "row.saverRule" on-text="On" off-text="Off" @click="updateSaverRuleStatus($index)"></base-switch>
                </el-tooltip>
                
                <el-tooltip content="Delete" :open-delay="300" placement="top">
                    <base-button type="danger" size="sm" icon @click="deleteDevice(row)">
